...
class Webui:
    ...
    def _respond(self, message, chat_history, hash_id):
        ...
        with gr.Blocks() as demo:
            ...
            with init_page:
                with gr.Tab("url"):
                    ...
                    url_submit_btn.click(
                        self._submit_url,
                        [url_box],
                        [url_error_box, url_box, init_page, chat_page, hash_id_state],
                    )
                ...
                with gr.Tab("file"):
                    ...
                    file_submit_btn.click(
                        self._submit_file,
                        [file_box],
                        [file_error_box, file_box, init_page, chat_page, hash_id_state],
                    )
            ...
            with chat_page:
                ...
                msg.submit(
                    ...
                    [msg, chatbot, dataset_box, kw_box],
                )
                submit_box.click(
                    self._respond,
                    [msg, chatbot, hash_id_state],
                ...
                reset_box.click(self._reset, None, [init_page, chat_page, chatbot, msg, dataset_box, hash_id_state])
